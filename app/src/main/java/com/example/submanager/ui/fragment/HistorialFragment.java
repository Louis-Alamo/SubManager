...
public class HistorialFragment extends Fragment {
    ...
    static class PagoMock {
        ...
        PagoMock(String nombre, String fechaCategoria, String monto, String colorHex) {
            this.nombre = nombre;
    ...
    private List<PagoMock> getMockPagos() {
        ...
        lista.add(new PagoMock("Netflix",      "5 Mar · Entretenimiento",  "-$199.00", "#EF4444"));
        lista.add(new PagoMock("Spotify",       "8 Mar · Música",           "-$129.00", "#22C55E"));
        lista.add(new PagoMock("Xbox Game Pass","10 Mar · Gaming",          "-$249.00", "#3B82F6"));
        lista.add(new PagoMock("Luz Eléctrica", "15 Mar · Hogar",           "-$640.00", "#F97316"));
        lista.add(new PagoMock("YouTube Premium","18 Mar · Entretenimiento","-$139.00", "#EC4899"));
        lista.add(new PagoMock("Internet",      "20 Mar · Hogar",           "-$450.00", "#7C3AED"));
        return lista;
    }
    ...
    private static class PagoAdapter extends RecyclerView.Adapter<PagoAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull VH h, int pos) {
            ...
            try {
                h.vColorDot.getBackground().setTint(Color.parseColor(p.colorHex));
